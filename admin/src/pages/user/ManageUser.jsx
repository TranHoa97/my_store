...
import { getUsersByFilter, getUsersByGroup } from '../../redux/user/userRequest'
...
const ManageUser = () => {
    ...
    const handleSearch = debounce(async(e) => {
        ...
        if(group) {
            setSearchParams({ groupId: group, search: keyword })
        } else {
    ...
    const handleChange = (e) => {
        if(e === "all") {
            ...
            if(search) {
                setSearchParams({ groupId: e, search: search })
            } else {
                setSearchParams({ groupId: e })
            }
        }
    }
